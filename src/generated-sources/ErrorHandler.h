...
JJSimpleString addUnicodeEscapes(const JJString& str);
  ...
  class ErrorHandler {
    ...
    public:
      ...
      virtual void handleUnexpectedToken(int expectedKind, const JJString& expectedToken, Token *actual, Orb *parser) {
        error_count++;
      ...
      virtual void handleParseError(Token *last, Token *unexpected, const JJSimpleString& production, Orb *parser) {
        error_count++;
      ...
      virtual void handleOtherError(const JJString& message, Orb *parser) {
  ...
  class TokenManagerErrorHandler {
    ...
    public:
       ...
       //
       virtual void lexicalError(bool EOFSeen, int lexState, int errorLine, int errorColumn, const JJString& errorAfter, JJChar curChar, OrbTokenManager* token_manager) {
       ...
       virtual void lexicalError(const JJString& errorMessage, OrbTokenManager* token_manager) {
...
#endif
/* JavaCC - OriginalChecksum=878abf59eb1957726fec18a2c07cf283 (do not edit this line) */
